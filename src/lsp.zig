...
const stdlib_modules = [_]StdlibModule{
    ...
    .{ .name = "term", .functions = &.{
        .{ "cols", .{ .overloads = &.{.{ .params = &.{}, .return_type = "int" }}, .description = "Terminal width in columns. Returns 80 if not a TTY." } },
        .{ "rows", .{ .overloads = &.{.{ .params = &.{}, .return_type = "int" }}, .description = "Terminal height in rows. Returns 24 if not a TTY." } },
        .{ "size", .{ .overloads = &.{.{ .params = &.{}, .return_type = "Size" }}, .description = "Terminal dimensions as { cols, rows }." } },
        .{ "is_tty", .{ .overloads = &.{.{ .params = &.{}, .return_type = "bool" }}, .description = "True if stdout is connected to a terminal." } },
        .{ "move", .{ .overloads = &.{.{ .params = &.{.{ .name = "row", .type_name = "int" }, .{ .name = "col", .type_name = "int" }}, .return_type = null }}, .description = "Move cursor to absolute position (0-indexed)." } },
        .{ "move_to_col", .{ .overloads = &.{.{ .params = &.{.{ .name = "col", .type_name = "int" }}, .return_type = null }}, .description = "Move cursor to column on current line (0-indexed)." } },
        .{ "up", .{ .overloads = &.{.{ .params = &.{.{ .name = "n", .type_name = "int" }}, .return_type = null }}, .description = "Move cursor up n lines." } },
        .{ "down", .{ .overloads = &.{.{ .params = &.{.{ .name = "n", .type_name = "int" }}, .return_type = null }}, .description = "Move cursor down n lines." } },
        .{ "save", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Save cursor position." } },
        .{ "restore", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Restore saved cursor position." } },
        .{ "clear_line", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Clear the current line and move cursor to start." } },
        .{ "clear_down", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Clear from cursor to bottom of screen." } },
        .{ "clear_screen", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Clear entire screen and move cursor to top-left." } },
        .{ "hide_cursor", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Hide the terminal cursor." } },
        .{ "show_cursor", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Show the terminal cursor." } },
        .{ "scroll_region", .{ .overloads = &.{.{ .params = &.{.{ .name = "top", .type_name = "int" }, .{ .name = "bottom", .type_name = "int" }}, .return_type = null }}, .description = "Set scroll region (0-indexed). Lines outside the region don't scroll." } },
        .{ "reset_scroll", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Reset scroll region to full screen." } },
        .{ "raw", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Enter raw mode. Disables line buffering, echo, and signal handling." } },
        .{ "cooked", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Exit raw mode. Restores original terminal settings." } },
        .{ "read_key", .{ .overloads = &.{.{ .params = &.{}, .return_type = "str?" }}, .description = "Read a keypress. Returns key name (\"up\", \"enter\", \"escape\") or the character. Requires raw mode." } },
        .{ "flush", .{ .overloads = &.{.{ .params = &.{}, .return_type = null }}, .description = "Flush stdout." } },
        .{ "style", .{ .overloads = &.{.{ .params = &.{.{ .name = "text", .type_name = "str" }, .{ .name = "opts", .type_name = "map" }}, .return_type = "str" }}, .description = "Apply ANSI styling to text. Options: fg, bg (color name), bold, dim, italic, underline (bool). Returns plain text if not a TTY." } },
    } },
};
